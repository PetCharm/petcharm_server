...
class Post(models.Model):
    ...
    post_senti = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    post_keywords = models.CharField(max_length=500, blank=True, null=True)
...
class TracePath(models.Model):
    ...
    trace_path_coordinates = models.TextField(blank=True, null=True)
