...
urlpatterns = [
    ...
    path('api/user/login/', myapp.views.LoginView.as_view()),
    path('api/user/register/', myapp.views.RegisterView.as_view()),
    path('api/user/logout/', myapp.views.LogoutView.as_view()),
